...
2. **Script Python**: Realiza las tareas de navegación, captura, OCR y guardado en BD. Se ejecutará desde OpenClaw via `exec`.
...
- [ ] Instalar pip3 y herramientas de desarrollo Python
- [ ] Instalar Tesseract OCR (español e inglés)
- [ ] Instalar Chrome/Chromium y Playwright (navegador controlado)
...
### Fase 3: Desarrollo del script Python (una palabra clave)
- [ ] Escribir script `leadmaster_scraper.py` que:
  ...
  7. Extraiga texto de la imagen con Tesseract
...
2. Empezar Fase 1 (instalación de dependencias)
